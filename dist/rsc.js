...
var getInnerSize = function getInnerSize(el, dimension, padding1, padding2) {
  ...
  if (styles.boxSizing === "border-box") {
    return Math.max(
      0,
      (parseFloat(styles[dimension]) || 0) - (parseFloat(styles[padding1]) || 0) - (parseFloat(styles[padding2]) || 0)
    );
  }
...
var calcScrollForThumbOffset = function calcScrollForThumbOffset(
  contentSize,
  viewportSize,
  trackSize,
  thumbSize,
  ...
  (function () {
    ...
    Emittr.prototype.setMaxHandlers = function (count) {
      if (!isNum(count) || count <= 0) {
        throw new TypeError(
          "Expected maxHandlers to be a positive number, got '" + count + "' of type " + _typeof(count)
        );
      }
...
var AXIS_DIRECTION_PROP_TYPE = PropTypes__namespace.oneOf([AXIS_DIRECTION.X, AXIS_DIRECTION.Y]);
...
var TRACK_CLICK_BEHAVIOR_PROP_TYPE = PropTypes__namespace.oneOf([TRACK_CLICK_BEHAVIOR.JUMP, TRACK_CLICK_BEHAVIOR.STEP]);
...
var ScrollbarThumb =
  ...
  (function (_super) {
    ...
    ScrollbarThumb.propTypes = {
      ...
      onDrag: PropTypes__namespace.func,
      onDragStart: PropTypes__namespace.func,
      onDragEnd: PropTypes__namespace.func,
      elementRef: PropTypes__namespace.func,
      renderer: PropTypes__namespace.func,
    };
...
var ScrollbarTrack =
  ...
  (function (_super) {
    ...
    ScrollbarTrack.propTypes = {
      axis: AXIS_DIRECTION_PROP_TYPE,
      onClick: PropTypes__namespace.func,
      elementRef: PropTypes__namespace.func,
      renderer: PropTypes__namespace.func,
    };
  ...
  (function (_super) {
    ...
    function Scrollbar(props) {
      ...
      _this.update = function (force) {
        ...
        _this.scrollValues = scrollState; // Check if the status of whether scrolling is possible has changed, and if it has force a re-render. This handles
        ...
        (bitmask & (1 << 4) || bitmask & (1 << 5)) &&
          _this.eventEmitter.emit("scroll", __assign({}, scrollState), prevScrollState);
        ...
        if (_this.trackYElement) {
          if (
            ...
            if (scrollValues.scrollYPossible) {
              ...
              var thumbOffset = calcThumbOffset(
                scrollValues.scrollHeight,
                scrollValues.clientHeight,
                trackInnerSize,
                thumbSize,
      ...
      _this.handleTrackXClick = function (ev, values) {
        ...
        var thumbOffset =
          (_this.scrollValues.isRTL && shouldReverseRtlScroll()
            ...
            : values.offset - thumbSize / 2) - //@ts-ignore
          (parseFloat(getComputedStyle(_this.trackXElement).paddingLeft) || 0);
        var target = calcScrollForThumbOffset(
        ...
        if (_this.props.trackClickBehavior === TRACK_CLICK_BEHAVIOR.STEP) {
          target = (
            _this.scrollValues.isRTL ? _this.scrollValues.scrollLeft > target : _this.scrollValues.scrollLeft < target
          )
    ...
    Scrollbar.calculateStyles = function (props, state, scrollValues, scrollbarWidth) {
      ...
      return {
        holder: __assign(
          __assign(__assign({}, useDefaultStyles && style.holder), {
            position: "relative",
          }),
          props.style
        ),
          ...
          __assign(
            __assign(
              ...
              useDefaultStyles &&
                __assign(
                  __assign(
                    __assign({}, style.wrapper),
                    !props.disableTracksWidthCompensation &&
                      !props.disableTrackYWidthCompensation &&
                      ((_a = {}), (_a[state.isRTL ? "left" : "right"] = state.trackYVisible ? 10 : 0), _a)
                  ),
                  !props.disableTracksWidthCompensation &&
        ...
        content: __assign(
          __assign(
            __assign(
              __assign(
                __assign({}, useDefaultStyles && style.content),
                props.translateContentSizesToHolder ||
                  props.translateContentSizeYToHolder ||
                  props.translateContentSizeXToHolder
                  ? {
        ...
        scroller: __assign(
            ...
            __assign(
              __assign(
                ((_b = {
                  ...
                  right: 0,
                  paddingBottom:
                    !scrollbarWidth && scrollValues.scrollXPossible ? props.fallbackScrollbarWidth : undefined,
                }),
                (_b[state.isRTL ? "paddingLeft" : "paddingRight"] =
          ...
          (_c[state.isRTL ? "marginLeft" : "marginRight"] = scrollValues.scrollYPossible
            ? -(scrollbarWidth || props.fallbackScrollbarWidth) - Number(scrollValues.zoomLevel !== 1)
            : undefined),
          _c)
        ),
        trackX: __assign(
          __assign(
            __assign(__assign({}, useDefaultStyles && style.track.common), useDefaultStyles && style.track.x),
        ...
        trackY: __assign(
          __assign(
            __assign(
              __assign(__assign({}, useDefaultStyles && style.track.common), useDefaultStyles && style.track.y),
              useDefaultStyles && ((_d = {}), (_d[state.isRTL ? "left" : "right"] = 0), _d)
            ),
        ...
        thumbX: __assign(
          __assign(__assign({}, useDefaultStyles && style.thumb.common), useDefaultStyles && style.thumb.x),
          props.thumbXProps.style
        ),
        thumbY: __assign(
          __assign(__assign({}, useDefaultStyles && style.thumb.common), useDefaultStyles && style.thumb.y),
    ...
    Scrollbar.prototype.render = function () {
      ...
      if (native || (!scrollbarWidth && mobileNative)) {
        ...
        var scrollerProps_1 = __assign(__assign({}, propsHolderProps), {
          ...
          style: __assign(
            __assign(
              __assign(
                __assign({}, propsHolderProps.style),
                !isUndef(rtl) && {
      ...
      if (this.state.trackYVisible || (!removeTracksWhenNotUsed && !removeTrackYWhenNotUsed)) {
        ...
        var trackYProps = __assign(
          __assign(
            __assign(__assign({}, propsTrackYProps), {
      ...
      if (this.state.trackXVisible || (!removeTracksWhenNotUsed && !removeTrackXWhenNotUsed)) {
        ...
        var trackXProps = __assign(
          __assign(
            __assign(__assign({}, propsTrackXProps), {
    ...
    Scrollbar.propTypes = {
      createContext: PropTypes__namespace.bool,
      rtl: PropTypes__namespace.bool,
      native: PropTypes__namespace.bool,
      mobileNative: PropTypes__namespace.bool,
      momentum: PropTypes__namespace.bool,
      noDefaultStyles: PropTypes__namespace.bool,
      disableTracksMousewheelScrolling: PropTypes__namespace.bool,
      disableTrackXMousewheelScrolling: PropTypes__namespace.bool,
      disableTrackYMousewheelScrolling: PropTypes__namespace.bool,
      disableTracksWidthCompensation: PropTypes__namespace.bool,
      disableTrackXWidthCompensation: PropTypes__namespace.bool,
      disableTrackYWidthCompensation: PropTypes__namespace.bool,
      minimalThumbSize: PropTypes__namespace.number,
      maximalThumbSize: PropTypes__namespace.number,
      minimalThumbXSize: PropTypes__namespace.number,
      maximalThumbXSize: PropTypes__namespace.number,
      minimalThumbYSize: PropTypes__namespace.number,
      maximalThumbYSize: PropTypes__namespace.number,
      noScrollX: PropTypes__namespace.bool,
      noScrollY: PropTypes__namespace.bool,
      noScroll: PropTypes__namespace.bool,
      permanentTrackX: PropTypes__namespace.bool,
      permanentTrackY: PropTypes__namespace.bool,
      permanentTracks: PropTypes__namespace.bool,
      translateContentSizesToHolder: PropTypes__namespace.bool,
      translateContentSizeYToHolder: PropTypes__namespace.bool,
      translateContentSizeXToHolder: PropTypes__namespace.bool,
      removeTracksWhenNotUsed: PropTypes__namespace.bool,
      removeTrackYWhenNotUsed: PropTypes__namespace.bool,
      removeTrackXWhenNotUsed: PropTypes__namespace.bool,
      trackClickBehavior: TRACK_CLICK_BEHAVIOR_PROP_TYPE,
      scrollbarWidth: PropTypes__namespace.number,
      fallbackScrollbarWidth: PropTypes__namespace.number,
      scrollDetectionThreshold: PropTypes__namespace.number,
      scrollTop: PropTypes__namespace.number,
      scrollLeft: PropTypes__namespace.number,
      className: PropTypes__namespace.string,
      wrapperProps: PropTypes__namespace.object,
      contentProps: PropTypes__namespace.object,
      trackXProps: PropTypes__namespace.object,
      trackYProps: PropTypes__namespace.object,
      thumbXProps: PropTypes__namespace.object,
      thumbYProps: PropTypes__namespace.object,
      onUpdate: PropTypes__namespace.func,
      onScroll: PropTypes__namespace.func,
      onScrollStart: PropTypes__namespace.func,
      onScrollStop: PropTypes__namespace.func,
    };
