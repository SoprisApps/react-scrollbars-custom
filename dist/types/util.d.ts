 ...
 */
export declare const renderDivWithRenderer: (
 ...
 */
export declare const calcThumbSize: (
  contentSize: number,
  viewportSize: number,
  trackSize: number,
  minimalSize?: number | undefined,
  maximalSize?: number | undefined
) => number;
/**
 ...
 */
export declare const calcThumbOffset: (
  contentSize: number,
  viewportSize: number,
  trackSize: number,
  thumbSize: number,
 ...
 */
export declare const calcScrollForThumbOffset: (
  contentSize: number,
  viewportSize: number,
  trackSize: number,
  thumbSize: number,
